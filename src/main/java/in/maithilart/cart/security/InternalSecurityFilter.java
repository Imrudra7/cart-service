package in.maithilart.cart.security;
...
public class InternalSecurityFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		String expectedSecret = path.startsWith("/cart/api/internal/") ? internalSecret : gatewaySecret;

		String headerName = path.startsWith("/cart/api/internal/") ? "X-Internal-Secret" : "X-Gateway-Secret";
